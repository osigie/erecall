...
class ExpenseToolServiceTests {
  ...
  @InjectMocks private ExpenseToolServiceImpl toolService;
  ...
  void saveExpense_withMerchant_shouldSaveAndReturnFormattedString() {
    ...
    assertThat(result)
        .isEqualTo("Saved Netflix subscription at Netflix for 15.99 under ENTERTAINMENT");
  ...
  void searchDatabase_shouldFilterByUserId() {
    ...
    var result =
        toolService.searchDatabase(ExpenseCategory.MISCELLANEOUS, "Amazon", null, toolContext());
