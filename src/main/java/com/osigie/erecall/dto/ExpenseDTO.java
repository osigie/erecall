...
public class ExpenseDTO {
  ...
  public record Request(String rawText, String fileUrl) {
    public ExpenseDocument toDocument() {
      return ExpenseDocument.builder().rawText(rawText).fileUrl(fileUrl).build();
    }
  }
  ...
  public record StatusResponse(
      UUID documentId, DocumentProcessingStatus status, String aiResponse, ExpenseData expense) {}
